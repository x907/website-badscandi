    ...
    <div className="container mx-auto px-4 sm:px-6 py-8 sm:py-12">
      <div className="max-w-3xl mx-auto space-y-8 sm:space-y-12">
        <div className="space-y-3 sm:space-y-4">
          <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-foreground">About Bad Scandi</h1>
          ...
          <a
            ...
            className="group flex items-center gap-4 p-4 bg-muted border border-border rounded-lg hover:bg-muted/80 transition-colors"
          >
            <div className="flex-shrink-0 w-16 h-16 sm:w-20 sm:h-20 rounded overflow-hidden bg-amber-500/10 border border-border flex items-center justify-center">
              <span className="text-amber-700 dark:text-amber-400 font-serif text-lg sm:text-xl font-medium">MDM</span>
            </div>
            <div className="flex-1 min-w-0">
              <p className="text-xs uppercase tracking-wide text-muted-foreground mb-1">As featured in</p>
              <p className="font-medium text-foreground group-hover:text-amber-700 dark:group-hover:text-amber-400 transition-colors">
            ...
            <svg className="w-5 h-5 text-muted-foreground group-hover:text-amber-700 dark:group-hover:text-amber-400 flex-shrink-0 transition-colors" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="space-y-4 sm:space-y-6">
          <h2 className="text-xl sm:text-2xl font-semibold text-foreground">Meet Ashley</h2>
        ...
        <div className="space-y-4 sm:space-y-6">
          <h2 className="text-xl sm:text-2xl font-semibold text-foreground">The Creative Process</h2>
          <p className="text-muted-foreground leading-relaxed">
        ...
        <div className="space-y-4 sm:space-y-6">
          <h2 className="text-xl sm:text-2xl font-semibold text-foreground">Materials</h2>
          <p className="text-muted-foreground leading-relaxed">
        ...
        <div className="space-y-4 sm:space-y-6">
          <h2 className="text-xl sm:text-2xl font-semibold text-foreground">Custom Commissions</h2>
          <p className="text-muted-foreground leading-relaxed">
          ...
          <p className="text-muted-foreground leading-relaxed">
            ...
            <a href="/contact" className="text-amber-700 dark:text-amber-400 hover:underline font-medium">
              Get in touch
            </a>{" "}
